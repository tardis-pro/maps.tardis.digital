...
// //   }
// // };
// //  create a factory ffor building a layer withh reasonable  defaults  and configuration
// //  options     
// //  @param {Object} layerClass - the layer class to build   
// //  @param {Object} options - options to configure the layer    
// //  @param {Object} options.data - the data to use for the layer    
