...
const AnalyticsPanel: React.FC = () => {
  ...
  // Use Visualization context for visualization settings
  const { visualizationSettings } = useVisualization();
      ...
      <div className="analytics-content">
        ...
        {selectedAnalyticsMode === 'spatial' && (
          <div className="analytics-mode-section">
            ...
            <button
              className="apply-btn"
              disabled={selectedDatasetIds.length === 0 || isLoading || analysisLoading}
              onClick={handleSpatialAnalysis}
            >
              {isLoading || analysisLoading ? 'Processing...' : 'Apply Spatial Analysis'}
            </button>
          </div>
        )}
        ...
        {selectedAnalyticsMode === 'statistical' && (
          <div className="analytics-mode-section">
            ...
            >
              {isLoading || analysisLoading ? 'Processing...' : 'Apply Statistical Analysis'}
            </button>
          </div>
        )}
        ...
        {selectedAnalyticsMode === 'temporal' && (
          <div className="analytics-mode-section">
            ...
            >
              {isLoading || analysisLoading ? 'Processing...' : 'Apply Temporal Analysis'}
            </button>
          </div>
        )}
