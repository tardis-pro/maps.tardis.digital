...
const SpatialAnalysisPanel: React.FC<SpatialAnalysisPanelProps> = ({
    ...
    const { startAnalysis, addAnalysisResult, setAnalysisError } =
        useAnalysis();
    ...
    const [isochroneMinutes, setIsochroneMinutes] =
        useState<string>('5,10,15,30');
    ...
    const runAnalysis = () => {
        ...
        try {
            ...
            if (
                ...
                (!secondaryDataset || !datasets[secondaryDataset]?.data)
            ) {
                throw new Error(
                    'Secondary dataset is required for this analysis'
                );
            }
            ...
            const analysisResultData: AnalysisResult = {
                ...
                parameters: {
                    primaryDataset,
                    secondaryDataset: needsSecondaryDataset()
                        ? secondaryDataset
                        : undefined,
                    bufferRadius:
                ...
                sourceDatasets: needsSecondaryDataset()
            ...
            <div className="analysis-form">
                <div className="form-group">
                    ...
                    >
                        ...
                        <option value={AnalysisType.INTERSECTION}>
                            Intersection
                        </option>
                        <option value={AnalysisType.UNION}>Union</option>
                        <option value={AnalysisType.DIFFERENCE}>
                            Difference
                        </option>
                        <option value={AnalysisType.POINTS_IN_POLYGON}>
                            Points in Polygon
                        </option>
                        <option value={AnalysisType.CLUSTER}>Cluster</option>
                        <option value={AnalysisType.ISOCHRONES}>
                            Isochrones
                        </option>
                        <option value={AnalysisType.HOTSPOT}>
                            Hotspot Analysis
                        </option>
                    </select>
                </div>
                ...
                {needsSecondaryDataset() && (
                    <div className="form-group">
                        <label htmlFor="secondary-dataset">
                            Secondary Dataset
                        </label>
                        <select
                ...
                {selectedAnalysis === AnalysisType.ISOCHRONES && (
                    <>
                        <div className="form-group">
                            <label htmlFor="isochrone-minutes">
                                Isochrone Minutes (comma-separated)
                            </label>
                            <input
                                ...
                                onChange={(e) =>
                                    setIsochroneMinutes(e.target.value)
                                }
                    ...
                    <>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                value={cellSize}
                                onChange={(e) =>
                                    setCellSize(parseFloat(e.target.value))
                                }
                            />
                        </div>
                        <div className="form-group">
                            <label htmlFor="weight-property">
                ...
                <button
                    ...
                    disabled={
                        isLoading ||
                        !primaryDataset ||
                        (needsSecondaryDataset() && !secondaryDataset)
                    }
                >
                    ...
                    <div className="result-actions">
                        <button
                            ...
                            onClick={() => {
                                ...
                                if (analysisResult) {
                                    alert(
                                        'Result added to Analysis context. Map will display from context.'
                                    );
                                }
                            }}
                        >
