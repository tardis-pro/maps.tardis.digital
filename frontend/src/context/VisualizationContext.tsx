...
export function VisualizationProvider({ children }: { children: ReactNode }) {
    const [visualizationSettings, setVisualizationSettings] = useState<
        Record<string, VisualizationSettings>
    >({});
    const [dataColor, setDataColorState] = useState<
    ...
    const updateColorRamp = useCallback(
        (datasetId: string, colorRamp: ColorRamp) => {
            setVisualizationSettings((prev) => {
    ...
    const updateFilterRange = useCallback(
        (datasetId: string, filterRange: [number, number]) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
    ...
    const updateAggregation = useCallback(
        (datasetId: string, aggregation: AggregationType) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
    ...
    const updateAggregationResolution = useCallback(
        (datasetId: string, aggregationResolution: number) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
    ...
    const toggleLegend = useCallback(
        (datasetId: string, showLegend: boolean) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
    ...
    const updateElevationScale = useCallback(
        (datasetId: string, elevationScale: number) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
    ...
    const toggleExtruded = useCallback(
        (datasetId: string, extruded: boolean) => {
            setVisualizationSettings((prev) => {
                if (!prev[datasetId]) return prev;
                return {
                    ...prev,
