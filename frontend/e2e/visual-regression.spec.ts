...
test.describe('Map Component Visual Regression', () => {
    ...
    test('should render map correctly at default location', async ({
        page,
    }) => {
        ...
        const mapContainer = page.locator(
            '.maplibregl-map, [class*="MapContainer"]'
        );
    ...
    test('should render map controls correctly', async ({ page }) => {
        ...
        const zoomControls = page.locator(
            '[class*="zoom"], .maplibregl-ctrl-zoom'
        );
    ...
    test('should render different zoom levels correctly', async ({ page }) => {
        ...
        await expect(page.locator('.maplibregl-map')).toHaveScreenshot(
            'map-zoom-city.png'
        );
    });

    test('should maintain consistent rendering across sessions', async ({
        page,
    }) => {
